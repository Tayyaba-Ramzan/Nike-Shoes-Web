    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-12 lg:gap-96 px-4 mt-6">
        <div className="flex items-center gap-4">
          <h4 className="text-[18px] font-medium">Shop Men's</h4>
        ...
        <div className="flex items-center gap-4">
          <h4 className="text-[18px] font-medium">Shop Women's</h4>
          <Image src="/images/arrow.svg" alt="arrow" height={24} width={24} />
          <Image src="/images/circle-arrow.svg" alt="circle-arrow" height={48} width={48} />
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-around gap-6 px-4 mt-12">
        ...
        <div className="flex flex-col items-center max-w-[300px]">
          ...
          <p className="text-gray-600 text-center mt-1">Men's Short-Sleeve Running Top</p>
        </div>
        <div className="flex flex-col items-center max-w-[300px]">
          ...
          <p className="text-gray-600 text-center mt-1">Men's 18cm (approx.) 2-in-1 Versatile Shorts</p>
        </div>
        ...
        <div className="flex flex-col items-center max-w-[300px]">
          ...
          <p className="text-gray-600 text-center mt-1">Women's Long-Sleeve Running Top</p>
        </div>
        <div className="flex flex-col items-center max-w-[300px]">
