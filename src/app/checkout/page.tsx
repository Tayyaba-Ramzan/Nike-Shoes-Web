...
const CheckOutPage = () => {
    ...
    Customs regulation for India require a copy of the recipient's KYC. The address on the KYC needs to match the shipping address. Our courier will contact you via SMS/email to obtain a copy of your KYC. The KYC will be stored securely and used solely for the purpose of clearing customs (including sharing it with customs officials) for all orders and returns. If your KYC does not match your shipping address, please click the link for more information. Learn More
                    ...
                    <form>
                        ...
                        <h1 className='font-bold text-lg mt-8 mb-4'>What's your contact information?</h1>
                        <input
                            type='text'
                            placeholder='Email'
                            className='w-full md:w-[440px] h-[56px] border border-[#757575] pl-4'
                        ...
                        <h1 className='font-bold text-lg mt-6'>What's your PAN?</h1>
                        <input
                            type='text'
                            placeholder='PAN'
                            className='w-full md:w-[440px] h-[56px] border border-[#757575] pl-4'
...
<div className='flex items-start justify-start gap-8 flex-col text-[#757575]'>
    ...
    <div className='flex items-start flex-col'>
        <h3 className='w-full sm:w-[100.53px] h-[120px] text-black'>Nike Dri-FIT ADV TechKnit Ultra Men's Short-Sleeve Running Top</h3>
        <span>Qty 1</span>
        <span>Size L</span>
        <span>₹ 3 895.00</span>
    </div>
...
<div className='flex items-start justify-start gap-4 mt-4 flex-col sm:flex-row'>
    ...
    />
    <div className='flex items-start flex-col'>
        <h3 className='w-full sm:w-[99.26px] h-[72px] text-black'>Nike Air Max 97 SE Men's Shoes</h3>
        <span>Qty 1</span>
        <span>Size UK 8</span>
        <span>₹ 16 995.00</span>
    </div>
